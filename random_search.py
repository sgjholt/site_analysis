...
def main():
    ...
    rd = '/data/share/Japan/SiteInfo/S_B/{0}_synth_Vs_MC_subl/'.format(site)
    ...
    sub_uniform_search(site, wd, rd, 25, 10, iterations, name, (0.4, 0.6), 1, 0, (0.5, 25), 100, False, False, None,
                       (1, 2, 3))
